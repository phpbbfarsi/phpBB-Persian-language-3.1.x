...
$lang = array_merge($lang, array(
	...
	'SMTP_SERVER_EXPLAIN'			=> 'پروتوکل های مورد استفاده سرور خود را دراین بخش بنویسید. چنانچهاز پروتوکول های SSL استفاده میکنید از این ادرس ssl://your.mailserver.com بهره بگیرید.',
...
$lang = array_merge($lang, array(
	...
	'JAB_PASSWORD_EXPLAIN'			=> '<em><strong>هشدار:</strong>این پسورد به صورت فایل متنی در پایگاه داده ذخیره میشود و برای کسانی که به آن دسترسی دارتد و یا بتوانند به فایل های تنظیمات دسترسی داشته باشند قابل مشاهده است. </em>',    'JAB_PORT'						=> 'انتقال Jabber',
	...
	'JAB_USE_SSL_EXPLAIN'			=> 'چنانچه اتصال امن برقرار یا سعی در ایجاد آن شود درگاه Jabber به 5223 از 5222 تغییر میکند ',	'JAB_USERNAME'					=> 'نام کاربری Jabber یا JID',
	'JAB_USERNAME_EXPLAIN'			=> 'یک نام کاربری ثبت نام شده یا یک JID معتبر مشخص کنید. اگر تنها یک نام کاربری مشخص کنید آنگاه JID شما نام کاربری در سرور شما مشخص میشوددر غیر ا ین صورت یک JID معتبر مشخص کنید مثلا  user@jabber.org.',	'JAB_VERIFY_PEER'				=> 'تایید گواهینامه SSL',
