...
$lang = array_merge($lang, array(
    ...
    'CONVERT_COMPLETE_EXPLAIN'	=> 'انجمن شما با موفقیت به نسخه phpBB 3.1 ارتقا پیدا کرد شما میتوانید هم اکنوان وارد اکانت خود شوید.<a href="../">دسترسی به انجمن</a>. لطفا قبل از حذف پوشه نصب و فعال سازی انجمن از تغییر تمامی تنظیمات جدید اطمینان حاصل نمایید. راهنمای استفاده از این سیستم در این آدرس موجود است. <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Documentation</a> و <a href="https://www.phpbb.com/community/viewforum.php?f=466">انجمن پشتیبانی</a>.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
        ...
        <p>با کلیک رو گزینه زیر شما به فرمی جهت ارسال اطلاعات انجمن شما به مرکز phpBB هدایت خواهید شد. فرستادن این فرم باعث درک بهتر ما از این سیستم خواهد شد. پشتیبانی ما در این آدرس امکان پذیر است <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Documentation</a>, <a href="%3$s">مرابخوانید</a> و <a href="https://www.phpbb.com/community/viewforum.php?f=466">انجمن پشتیبانی</a>.</p><p><strong>لطفا قبل از استفاده از تالار پوشه نصب install را حذف و یا تغییر نام دهید. چنانچه این پوشه هنوز وجود داشته باشد تنها مرکز مدیریت انجمن در دسترس خواهد بود</strong>',
